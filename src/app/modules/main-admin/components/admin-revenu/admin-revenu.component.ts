...
@Component({
  selector: 'app-admin-revenu',
  templateUrl: './admin-revenu.component.html',
  styleUrls: ['./admin-revenu.component.scss']
})
export class AdminRevenuComponent implements OnInit {
